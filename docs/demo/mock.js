...
(function () {
  ...
  const dayView = { utcDate: day(0), u: 14.2, dailyNow: 2891, dailyNowSource: 'analytics', early: false, point: 6105, low: 5410, high: 6890, pace: 5200, fromTodayPosts: 1017, fromTails: 1874, regime: 'calibrating', postByLocal: '12:12', rangePct: 0.13, rangeSource: 'measured', rangeDays: 14, method: 'posts', rangeByHour: [[8,0.62],[10,0.41],[12,0.27],[14,0.16],[16,0.11],[18,0.07],[20,0.05],[22,0.03]].map(([localHour,pct])=>({localHour,pct})) };
